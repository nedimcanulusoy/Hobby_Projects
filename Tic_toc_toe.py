                ...
                for count, row in enumerate(game_map):
                        ...
                        for item in row:
                                if item == 0:
                                        ...
                                        colored_row += Fore.CYAN + ' O ' + Style.RESET_ALL
...
while play:
        ...
        while not game_won:
                ...
                played = False
                while not played:
                        column_choice = int(input("What column do you want to play? (O, 1, 2): "))
                        row_choice = int(input("What row do you want to play? (O, 1, 2): "))
